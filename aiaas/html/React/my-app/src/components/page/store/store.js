            ...
            <main className="storehome">
                ...
                <div className="storehome_latest_product">
                    ...
                    <div className="storehome_latest_product_card_container">
                        ...
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                            <Card400 name="iPone 16 Pro" describe="Apple Intelligence" price="₩1,550,000부터" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-iphone-16-pro-202409?wid=800&hei=1000&fmt=jpeg&qlt=90&.v=UzBXQnlhUWdraTNvNU1Kb3pEQlpXUHpnd0VsRWFiaWRaRHRaUXBvNTNkalNab1lJcUZwSFVRK1htYlNmZUtPTG54cStVNU5BQmhzbkxYRGxDWUc3R1lXVzNzT2dSajRTd2tFaEdoYUp2VnY1WVJVT21DTzBZRFlBTTZySFFMbHY"/>
                            </div>
                        </div>
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                            <Card400 name="iPad Air" describe="바람처럼 빠르게" price="₩949,000부터" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-ipad-air-202503?wid=800&hei=1000&fmt=p-jpg&qlt=95&.v=UzBXQnlhUWdraTNvNU1Kb3pEQlpXRFJ0OFRiWngrNGllYTMvQ1dlWDBQZjZXYXJlRUd1cTBYTnRnbTNlazIvMzRHeXB5TnVsU3R6Qjd0Y2JzbURyWEdJV2RaUklyUnViT0c4OGJXRWhUTnArYWpGdS9XeFgvbS9ITnNYOEhYaG4"/>
                            </div>
                        </div>
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                            <Card400 name="Apple Watch 프라이드 에디션 스포츠 밴드" describe="무지갯빛으로 당당하게." price="₩65,000" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-watch-pride-202505?wid=800&hei=1000&fmt=png-alpha&.v=QWhYaUFuRS9hTUliZ3N5RWVCV09vdDYvU0ZacGROckNJUjJGMTk0bnRxaHFTRjNxbmh1UnU2R29ibGdpZUFXc3V5NVU0QmM2b3hmeWJWTTVtN1o5ZnNZK25GTnpvbUY1UTI4WmI2VjkwM1YrYWpGdS9XeFgvbS9ITnNYOEhYaG4"/>
                            </div>
                        </div>
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                            <Card400 name="Apple Watch Series 10" describe="얇아진 두께. 더 커진 존재감." price="₩599,000부터" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-watch-s10-202409?wid=800&hei=1000&fmt=jpeg&qlt=90&.v=QWhYaUFuRS9hTUliZ3N5RWVCV09vbGtrQjBqdmhJbWlLcCtlQTMwc01SdjkvamYzRzRvcFlnajNacmhEOC9BeDE1UUxLT2t0cW42N3FvQzVqaGhrVVlSek45NHpYUG91NnZ3YmlDQlpUYnArYWpGdS9XeFgvbS9ITnNYOEhYaG4"/>
                            </div>
                        </div>
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                        ...
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                            <Card400 name="iPhone 16" describe="Apple Intelligence" price="₩1,250,000부터" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-iphone-16-202409?wid=800&hei=1000&fmt=jpeg&qlt=90&.v=UzBXQnlhUWdraTNvNU1Kb3pEQlpXSHNhd1RFMExoRHFBcWNCalJOblBtbjkvamYzRzRvcFlnajNacmhEOC9BeDE1UUxLT2t0cW42N3FvQzVqaGhrVVQ1UEcwSy9Yd3FpT0wveFRydDk3cE4rYWpGdS9XeFgvbS9ITnNYOEhYaG4"/>                           
                            </div>
                        </div>
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                            <Card400 name="Apple Watch Ultra 2" describe="블랙으로 계속되는 전력 질주." price="₩1,149,000부터" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-watch-ultra-202409_GEO_KR?wid=800&hei=1000&fmt=jpeg&qlt=90&.v=QWhYaUFuRS9hTUliZ3N5RWVCV09vbHdYN09OOVhGMkJZZWFPTlJDYlZ0VkFYdUFnVlgvUCtkRUM4dVJJUkRxSHAwckMxbExydC8yeDhtUjlFVHdKVnRSR0liZklwWjJ2eGlOd1dxRHFuOXFZUFpIL004NVhDbUZOOW82a2p5cS8"/>                           
                            </div>
                        </div>
                        <div className="list_item">
                            <div className="storehome_latest_product_card">
                ...
                <div className="storehome_shopping_reason">
                    ...
                    <div className="storehome_shopping_reason_main">
                        <div className="storehome_shopping_reason_card">
                            <div className="storehome_shopping_reason_card_container">
                                <div className="storehome_shopping_reason_card_container_card">
                        ...
                        <div className="storehome_shopping_reason_card">
                            <div className="storehome_shopping_reason_card_container">
                                <div className="storehome_shopping_reason_card_container_card">
                                    <div className="storehome_shopping_reason_card_container_icon">
                                        <svg width="40" height="56" viewBox="0 0 40 56" class="card_icon_elevated" aria-hidden="true">
                        ...
                        <div className="storehome_shopping_reason_card">
                            <div className="storehome_shopping_reason_card_container">
                                <div className="storehome_shopping_reason_card_container_card">
                                    <div className="storehome_shopping_reason_card_container_icon">
                                        <svg width="49" height="56" viewBox="0 0 49 56" class="card_icon" aria-hidden="true">
                        ...
                        <div className="storehome_shopping_reason_card">
                            <div className="storehome_shopping_reason_card_container">
                                <div className="storehome_shopping_reason_card_container_card">
                                    <div className="storehome_shopping_reason_card_container_icon">
                                        <svg width="40" height="56" viewBox="0 0 40 56" class="card_icon_elevated_purple" aria-hidden="true">
                                            <path d="m0 0h40v56h-40z" fill="none"></path>
                        ...
                        <div className="storehome_shopping_reason_card">
                            <div className="storehome_shopping_reason_card_container">
                                <div className="storehome_shopping_reason_card_container_card">
                                    <div className="storehome_shopping_reason_card_container_icon">
                                        <svg viewBox="0 0 36 56" width="36" height="56" class="card_icon_elevated_navy" aria-hidden="true">
                ...
                {/* 액세서리 카드 */}
                <div className= "storehome_shopping_product_accessories">
                    <div className="storehome_shopping_product_accessories_container">
                        <div className="storehome_shopping_product_accessories_title">
                            <span className="storehome_title_text_black">액세서리.</span>
                            <span className="storehome_title_text_gray">즐겨 사용하는 기기들과 완벽하게 페어링되는 여러 가지 필수품.</span>
                        </div>
                        <div className="storehome_shopping_product_accessories_card">
                            <div className="storehome_shopping_product_accessories_card_container">
                                <Card400 name="새로움을 입다." describe="사랑받는 액세서리들로 더욱 신선하고 다채롭게" path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-accessories-story-202503?wid=800&hei=1000&fmt=p-jpg&qlt=95&.v=K1NBYnFSRndoRHEyUklJLyttMlQ2TDJZSWVLNGdhSUJlSmNGa21DNVh4dEM0NE1nb1loei9zeXJYUS9EcFBOenN2Mmx4a3VvSnUzaFUvSVlVRUJkbEFxYi9OZSszSzhrMXYreWkvWm03emFWZjFod0MwSDdqOFJDWWdyWjF0NmQ"/>
                            </div>
                            <div className="storehome_shopping_product_accessories_card_container_card">
                ...
                {/*음향기기 쇼핑 카드 */}
                <div className="storehome_shopping_product_audio">
                    <div className="storehome_shopping_product_audio_container">
                        <div className="storehome_shopping_product_audio_title">
                            <span className="storehome_title_text_black">음향기기.</span>
                            <span className="storehome_title_text_gray">즐겨 사용하는 기기들과 완벽하게 페어링되는 여러 가지 필수품.</span>
                        </div>
                        <div className="storehome_shopping_product_audio_card">
                            <div className="storehome_shopping_product_audio_card_container">
                                <Card400 name="Apple Music 3개월 무료 이용 혜택." describe="해당 Apple 기기 구입 시 혜택 제공." path="#" image="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-50-apple-music-202412?wid=800&hei=1000&fmt=p-jpg&qlt=95&.v=SFNxMjRYSTFLdjBJZG1UYjBKRUNDc21KWElzeGUrOVROazhWUi9vMy9xUnFTRjNxbmh1UnU2R29ibGdpZUFXc0prY3crUWRsN1dqVjRnMHR5S1hVbkVOdXo5Z2c3b1kwaDdELytwanYzTEc2S2VFaVNLbFRwRnRocGdXWjBnQ0Y"/>
                            </div>
                            <div className="storehome_shopping_product_audio_card_container_card">
